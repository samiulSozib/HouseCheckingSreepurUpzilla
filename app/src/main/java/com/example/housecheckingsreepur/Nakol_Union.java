...
public class Nakol_Union extends AppCompatActivity implements TextWatcher, CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nakol__union);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Nakol_Union.this,MainActivity.class));
        finish();
        super.onBackPressed();
    }
    ...
    private void adduser() {
        if (upokar_vogir_nam.getText().toString().equals("") || upokar_vogir_pita_samir_nam.getText().toString().equals("") || national_id.getText().toString().equals("") || mobile.getText().toString().equals("")|| montobbo.getText().toString().equals("")||jacaikari.getText().toString().equals("")){
            Toast.makeText(Nakol_Union.this,"Please fill all fields",Toast.LENGTH_SHORT).show();
        }else if(!national_id.getText().toString().equals(confirm_national_id.getText().toString())){
            Toast.makeText(Nakol_Union.this,"National Id does not match",Toast.LENGTH_SHORT).show();
        }else if(!mobile.getText().toString().equals(confirm_mobile.getText().toString())){
            Toast.makeText(Nakol_Union.this,"Moobile Number Does not match",Toast.LENGTH_SHORT).show();
        }else if (mobile.getText().toString().length()!=11){
            Toast.makeText(Nakol_Union.this,"Mobile Number Must be 11 digit",Toast.LENGTH_SHORT).show();
        }else if((national_id.getText().toString().length()>17) || (national_id.getText().toString().length()<10)){
            Toast.makeText(Nakol_Union.this,"National id recheck",Toast.LENGTH_SHORT).show();
        }else if(userImage==null){
            Toast.makeText(Nakol_Union.this,"Image Must not be empty",Toast.LENGTH_SHORT).show();
        }
        else{
            //addItemToSheet();
            ///---------------------
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,ADD_USER_URL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            loading.dismiss();
                            Toast.makeText(Nakol_Union.this,response,Toast.LENGTH_LONG).show();
                            startActivity(new Intent(Nakol_Union.this,Nakol_Union.class));
                            finish();
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(Nakol_Union.this,error.toString(),Toast.LENGTH_LONG).show();
                        }
                    }){
                @Override
    ...
    public void showData(View view) {
        startActivity(new Intent(Nakol_Union.this,UserList.class));
    }

...
public class Amolsar_Union extends AppCompatActivity implements TextWatcher, CompoundButton.OnCheckedChangeListener{

    EditText upokar_vogir_nam,upokar_vogir_pita_samir_nam,national_id,confirm_national_id,mobile,montobbo,confirm_mobile,jacaikari;
    ImageView imageViewUserImage;
    Spinner gram_para_spinner,word_no_spinner,mot_jomi_spinner;
    String[] gram_spinner={"বদনপুর","সুন্দরপুর","বিলনাথুর","আমলসার","মাতিয়াপাড়া","ইন্দুরবাড়িয়া","রাক্সাকান্দি","বিলসুনাই","কচু্বাড়িয়া","চরপাড়া ",
            "চরইসলামপুর","আমলসার কুদলা ","করুন্দি কুদলা","রামচন্দ্রপুর","করুন্দি","করুন্দি বালিয়াঘাটা","পশ্চিম রাজাপুর বালিয়াঘাটা","কালিনগর","চর উদাস","ছোট উদাস",
            "দূর্গাপুর","পূর্বরাজাপুর","পশ্চিম রাজাপুর","টিকারবিলা","চরিয়াপাড়া ","দরিয়াপাড়া","আধারকোঠা","আড়ুয়াডাঙ্গি","রামচন্দ্রপুর","চর রামচন্দ্রপুর"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amolsar__union);
    ...
    public void onBackPressed() {
        startActivity(new Intent(Amolsar_Union.this,MainActivity.class));
        finish();
        super.onBackPressed();
    }
    ...
    private void adduser() {
        if (upokar_vogir_nam.getText().toString().equals("") || upokar_vogir_pita_samir_nam.getText().toString().equals("") || national_id.getText().toString().equals("") || mobile.getText().toString().equals("")|| montobbo.getText().toString().equals("")||jacaikari.getText().toString().equals("")){
            Toast.makeText(Amolsar_Union.this,"Please fill all fields",Toast.LENGTH_SHORT).show();
        }else if(!national_id.getText().toString().equals(confirm_national_id.getText().toString())){
            Toast.makeText(Amolsar_Union.this,"National Id does not match",Toast.LENGTH_SHORT).show();
        }else if(!mobile.getText().toString().equals(confirm_mobile.getText().toString())){
            Toast.makeText(Amolsar_Union.this,"Moobile Number Does not match",Toast.LENGTH_SHORT).show();
        }else if (mobile.getText().toString().length()!=11){
            Toast.makeText(Amolsar_Union.this,"Mobile Number Must be 11 digit",Toast.LENGTH_SHORT).show();
        }else if((national_id.getText().toString().length()>17) || (national_id.getText().toString().length()<10)){
            Toast.makeText(Amolsar_Union.this,"National id recheck",Toast.LENGTH_SHORT).show();
        }else if(userImage==null){
            Toast.makeText(Amolsar_Union.this,"Image Must not be empty",Toast.LENGTH_SHORT).show();
        }
        else{
            //addItemToSheet();
            ///---------------------
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST,ADD_USER_URL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            loading.dismiss();
                            Toast.makeText(Amolsar_Union.this,response,Toast.LENGTH_LONG).show();
                            startActivity(new Intent(Amolsar_Union.this,Amolsar_Union.class));
                            finish();
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(Amolsar_Union.this,error.toString(),Toast.LENGTH_LONG).show();
                        }
                    }){
                @Override
    ...
    public void showData(View view) {
        startActivity(new Intent(Amolsar_Union.this,UserList.class));
    }
